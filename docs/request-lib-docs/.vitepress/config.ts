      ...
      '/packages/': [
        {
          ...
          items: [
            ...
            { 
              ...
              collapsed: true,
              items: [
                { text: '缓存功能', link: '/packages/request-core/features/cache' },
                { text: '重试功能', link: '/packages/request-core/features/retry' },
                { text: '并发控制', link: '/packages/request-core/features/concurrent' },
                { text: '拦截器', link: '/packages/request-core/features/interceptors' }
              ]
            },
